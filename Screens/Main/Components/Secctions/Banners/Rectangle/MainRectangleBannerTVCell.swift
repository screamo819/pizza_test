//
//  MainRectangleBannerTVCell.swift
//  Qrooto
//
...
class MainRectangleBannerTVCell: MainBaseTVCell {
	...
	func setup(_ model: MainRectangleCellModel) {
...
private extension MainRectangleBannerTVCell {
